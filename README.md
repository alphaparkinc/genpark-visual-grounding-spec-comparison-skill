# genpark-visual-grounding-spec-comparison-skill
...
**genpark-visual-grounding-spec-comparison-skill** is a deterministic, zero-dependency Python skill engineered with 100% production-grade functional parity for autonomous AI search, retrieval fusion, and stateful agent execution.

> **Executive Capability**: Multimodal visual spec grounding engine calculating physical dimensions and DoF
...
result = client.compare_visual_specs()
print(result)
```
...
```json
{
  "mcpServers": {
    "genpark-visual-grounding-spec-comparison-skill": {
      "command": "python",
      "args": ["/path/to/genpark-visual-grounding-spec-comparison-skill/mcp_server.py"]
    }
  }
}
```
